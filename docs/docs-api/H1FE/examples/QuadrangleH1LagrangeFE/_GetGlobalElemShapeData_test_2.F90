...
SUBROUTINE test1
  ...
  CALL Display([1, 5, 9, 8], "Global node numbers: ")
  faceOrient = 0
  faceOrient(1, 1) = 1
  faceOrient(1, 2) = 1
  faceOrient(1, 3) = -1
  ...
  elemCoord(1:2, 4) = [0.0_DFP, 1.0_DFP]
  ...
  CALL feptr1%GetGlobalElemShapeData(xij=elemCoord(1:2, 1:4), &
...
SUBROUTINE test2
  ...
  CALL Display([8, 9, 7, 4], "Global node numbers: ")
  ...
  elemCoord = 0.0_DFP
  elemCoord(1:2, 1) = [0.0_DFP, 1.0_DFP]
  elemCoord(1:2, 2) = [1.0_DFP, 1.0_DFP]
  elemCoord(1:2, 3) = [1.0_DFP, 2.0_DFP]
  elemCoord(1:2, 4) = [0.0_DFP, 2.0_DFP]
  ...
  CALL feptr2%GetGlobalElemShapeData(xij=elemCoord(1:2, 1:4), &
...
SUBROUTINE test3
  ...
  CALL Display("test3: element 3")
  CALL Display([5, 2, 6, 9], "Global node numbers: ")
  ...
  elemCoord = 0.0_DFP
  elemCoord(1:2, 1) = [1.0_DFP, 0.0_DFP]
  elemCoord(1:2, 2) = [2.0_DFP, 0.0_DFP]
  elemCoord(1:2, 3) = [2.0_DFP, 1.0_DFP]
  elemCoord(1:2, 4) = [1.0_DFP, 1.0_DFP]

  feptr3 => QuadrangleH1LagrangeFEPointer( &
            order=1, nsd=2, ipType=TypeInterpolationOpt%equidistance, &
            basisType=[TypePolynomialOpt%monomial], &
            faceOrient=faceOrient, &
            quadratureIsHomogeneous=.TRUE., &
  ...
  CALL feptr3%GetRefElemCoord(ans=refElemCoord, nrow=nrow, ncol=ncol)
  CALL feptr3%GetInterpolationPoints( &
    xij=refElemCoord(1:2, 1:4), ans=xij, nrow=nrow, ncol=ncol, &
    order=[interpolationOrder], ipType=[TypeInterpolationOpt%Equidistance])
  ...
  CALL feptr3%SetOrder(order=1)
  CALL feptr3%GetLocalElemShapeData(elemsd=geoelemsd, quad=quad)

  CALL feptr3%SetOrder(order=4)
  CALL feptr3%GetLocalElemShapeData(elemsd=elemsd3, quad=quad)

  CALL feptr3%GetGlobalElemShapeData(xij=elemCoord(1:2, 1:4), &
...
SUBROUTINE test4
  ...
  CALL Display("test4: element 4")
  CALL Display([9, 6, 3, 7], "Global node numbers: ")
  ! 9, 6, 3, 7
  ...
  elemCoord = 0.0_DFP
  elemCoord(1:2, 1) = [1.0_DFP, 1.0_DFP]
  elemCoord(1:2, 2) = [2.0_DFP, 1.0_DFP]
  elemCoord(1:2, 3) = [2.0_DFP, 2.0_DFP]
  elemCoord(1:2, 4) = [1.0_DFP, 2.0_DFP]

  feptr4 => QuadrangleH1LagrangeFEPointer( &
            order=1, nsd=2, ipType=TypeInterpolationOpt%equidistance, &
            basisType=[TypePolynomialOpt%monomial], &
            faceOrient=faceOrient, &
            quadratureIsHomogeneous=.TRUE., &
  ...
  CALL feptr4%GetRefElemCoord(ans=refElemCoord, nrow=nrow, ncol=ncol)
  CALL feptr4%GetInterpolationPoints( &
    xij=refElemCoord(1:2, 1:4), ans=xij, nrow=nrow, ncol=ncol, &
    order=[interpolationOrder], ipType=[TypeInterpolationOpt%Equidistance])
  ...
  CALL feptr4%SetOrder(order=1)
  CALL feptr4%GetLocalElemShapeData(elemsd=geoelemsd, quad=quad)

  CALL feptr4%SetOrder(order=4)
  CALL feptr4%GetLocalElemShapeData(elemsd=elemsd4, quad=quad)

  CALL feptr4%GetGlobalElemShapeData(xij=elemCoord(1:2, 1:4), &
