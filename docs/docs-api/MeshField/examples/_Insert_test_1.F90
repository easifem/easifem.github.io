! We test `Set` method to construct an instance of ScalarField_.
! In this case the mesh field variable is supposed to vary with the space.
...
! To set the entries inside an instance of [ScalarMeshField_](ScalarMeshField_),
! first one must create an instance of [FEVariable_](../FEVariable/FEVariable_.md).
! Then one can pass this FEVariable to the instance of [ScalarMeshField_](ScalarMeshField_).
