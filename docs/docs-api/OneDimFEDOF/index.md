...
`OneDimFEDOF_` defines the abstract node in finite element method.
...
The following table provides an overview of all methods defined in the GetMethods submodule of the OneDimFEDOF_Class.
