...
INTEGER(I4B), PARAMETER :: quadratureType = GaussLegendre
...
CALL fe%GetLocalElemShapeData(elemsd=elemsd, quad=quad)

CALL Display(Mdencode(elemsd), "## elemsd "//CHAR_LF2)
