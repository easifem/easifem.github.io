...
DO
  ...
  IF (IsKeyDown(KEY_RIGHT)) ballPosition%x = ballPosition%x + 4.0
  IF (IsKeyDown(KEY_LEFT)) ballPosition%x = ballPosition%x - 4.0
  IF (IsKeyDown(KEY_UP)) ballPosition%y = ballPosition%y - 4.0
  IF (IsKeyDown(KEY_DOWN)) ballPosition%y = ballPosition%y + 4.0

  ballPosition%x = ballPosition%x + 3.0
