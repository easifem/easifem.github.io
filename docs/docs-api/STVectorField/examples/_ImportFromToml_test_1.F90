...
! In this example we will initiate the fedof outside the STVectorField
...
CHARACTER(*), PARAMETER :: tomlfilename = "./toml/STVectorField.toml"
...
CALL obj%Display("VectorField obj:")
