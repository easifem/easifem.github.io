...
! In the following case we will get C and invC
! Make sure C and invC are 6 by 6.
!
! In case of plane-stress and plane-strain we
! only access 3x3 block.
! SO in case of plane stress and plane-strain
! 3 by 3 matrix is also ok.
