...
! date: 2024-06-01
! summary: testing  lis_vector_set_values6
...
CALL lis_vector_set_values6(LIS_ADD_VALUE, 3_I4B, 2_I4B, 2_I4B, values, &
                            v, ierr)
...
CALL lis_vector_set_values6(LIS_INS_VALUE, 3_I4B, 2_I4B, 2_I4B, values, &
                            v, ierr)
