...
! date: 2024-06-01
! summary: testing  lis_vector_set_values8
...
CALL lis_vector_set_values8(LIS_ADD_VALUE, 3_I4B, 2_I4B, 2_I4B, values, &
                            v, 2.0_DFP, 1_I4B, 3_I4B, ierr)
...
CALL lis_vector_set_values8(LIS_INS_VALUE, 3_I4B, 2_I4B, 2_I4B, values, &
                            v, 2.0_DFP, 1_I4B, 3_I4B, ierr)
