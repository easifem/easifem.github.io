...
CALL MatVec(obj=csrmat, x=sol, y=rhs)
...
astr = "-i bicg -p ssor -print 3 -scale symm_diag"
...
CALL lis_solver_set_matrix(A_, solver, ierr)
...
CALL lis_solve_kernel(A_, rhs_, sol_, solver, precon, ierr)
CALL chkerr(ierr)
